...
function LoginModel({open,onClose}) {
  ...
  const handleGoogleAuth=async()=>{
    try {
      ...
      const { data } = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/auth/google`,{
        ...
        onClick={(e)=>{e.stopPropagation()}}>
          <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_3px_120px_rgba(0,0,0,0.8)] overflow-hidden'>
            ...
            <div className='relative px-8 pt-14 pb-10 text-center'>
                <h1 className='inline-block mb-6 px-4 py-1.5 rounded-full bg-white border border-white/10 text-xs text-zinc-800'>
